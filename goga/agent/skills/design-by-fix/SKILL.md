...
Related skills for improvement: `design-by-brainstorm` (alternative design flow), `design-by-changes` (generates the design document), `plan-by-design` (consumer of the design document).
