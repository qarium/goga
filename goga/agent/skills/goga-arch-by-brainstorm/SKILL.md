...
Если задача подразумевает использование внешних библиотек/технологий — прочитайте usages о них (в `.usages/cooks/`),
...
1. **Определите usages** — какие практики нужны типам в этой cell:
   ...
   - **Usages внешних библиотек** — если типы в этой cell используют внешнюю библиотеку,
     для которой есть usage-файл в проекте (`.usages/cooks/`), подключите его через директиву `Usages`.
