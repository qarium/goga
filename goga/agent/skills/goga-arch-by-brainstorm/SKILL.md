...
- **Из файла задачи** — путь к файлу `docs/proposals/<topic>.md`, сформированному скиллом `goga-task-by-proposing`
...
16. **Базовые usages из конфигурации** — если скилл `goga-codemanifest-base` вернул базовые usages, каждая
    базовая практика включена в директиву `Usages` всех CODEMANIFEST и на неё есть ссылка хотя бы в одной аннотации
17. **Базовые annotations из конфигурации** — если скилл `goga-codemanifest-base` вернул базовые annotations, базовые
