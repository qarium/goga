...
- Принципов написания usage файлов при создании `.usages/cooks/`
...
2. **Определите внешние зависимости** — нужны ли компоненты, которых ещё нет в проекте:
   ...
   - Для каждой внешней зависимости определите, есть ли уже usage-файл в проекте (`.usages/cooks/`)
...
- Определено, какие `.usages/cooks` файлы нужно создать или обновить

### Фаза 5: Работа с .usages/cooks
...
2. **Дождитесь обратной связи** — пользователь утверждает или просит изменения
   - **Утверждено** → создайте файл `.usages/cooks/<name>.md`
...
2. **Дождитесь обратной связи** — пользователь утверждает или просит изменения
   - **Утверждено** → обновите файл `.usages/cooks/<name>.md`
...
|-----------|-----------|--------|
| <name> | `.usages/cooks/<name>.md` | создан / обновлён / существует |
