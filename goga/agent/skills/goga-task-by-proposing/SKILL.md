...
стеком, зависимостями и оценкой объёма. Результат сохраняется в `docs/proposals/<topic>.md` и становится входом для `goga-arch-by-brainstorm`.
...
**Цель:** Сохранить сформулированную задачу в файл `docs/proposals/<topic>.md`.
