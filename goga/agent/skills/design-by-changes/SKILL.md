...
2. **Пропустить** — оставить как есть, зафиксировать в дизайн-документе как известную проблему
3. **Предложить альтернативу** — пользователь описывает другое исправление
...
#### Шаг 6: Usages/`.usages/` consistency
