...
- `<файл>`: <описание> (причина пропуска: <решение пользователя>)

## Допущения

- <Допущение>: <основание> (критичность: <низкая/средняя/высокая>, безопасно продолжить без подтверждения: <да/нет>)

## Открытые вопросы

- <Вопрос>: <ответ пользователя (если есть)>
...
#### Проблемы, обнаруженные при трассировке
- <проблема>: <решение>
