...
Materialize the contracts of the topic "Extensible `goga init` onboarding: tool
participation via hooks actions and the dynamic image tag" into code: the four new
