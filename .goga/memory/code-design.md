...
## Own-state marker semantics

Indicators shown in aggregated views are derived from an entity's own direct state, never propagated from related or merged entities that merely carry its history.
