...
What each rule *means* semantically — the DSL itself — is covered in [Cell](../../cell/index.md); how the rules are implemented (the visitor, the analyzer, the error hierarchy) in [Internals](../../architecture/index.md).
