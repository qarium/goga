"""Contract tests for goga.codemanifest.factory package.
...
class TestBasicParsingHeaderImports:
    ...
    def test_import_type_without_alias(self, tmp_path) -> None:
        ...
        assert item.alias == ""
        assert item.from_path == "goga/codemanifest/nodes"
    ...
    def test_import_single_type(self, tmp_path) -> None:
        ...
        assert item.alias == ""
        assert item.from_path == "goga/codemanifest/errors"
...
class TestAllNodePropertiesPopulated:
    ...
    def test_import_item_all_fields(self, tmp_path) -> None:
        ...
        assert aliased.from_path == "goga/codemanifest/nodes"
