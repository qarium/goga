...
class TestLogic:
    ...
    def test_image_map_defaults_use_version_1_3(self) -> None:
        """All suggested Docker images use the current default tag `:1.3`."""
        ...
        for language, images in _IMAGE_MAP.items():
            ...
            for image in images:
                assert image.endswith(":1.3"), f"Image '{image}' for language '{language}' must use the :1.3 tag"
